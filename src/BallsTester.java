...
public class BallsTester {
    public static void main(String[] args) {
        ...
        Ball b1 = new Ball(200, 200, 200, Color.RED);
        Ball b2 = new Ball(200, 200, 300, Color.BLUE);
        Ball b3 = new Ball(-80, 249, 50, Color.GREEN);
        Ball b4 = new Ball(80, 249, 50, Color.GREEN);
        Ball b5 = new Ball(80, 249, 20, Color.black);
        Ball b6 = new Ball(200, 200, 0, Color.RED);
        ...
        String[] argsT = new String[]{"0", "0", "5", "2"};
        String title = "ball in the corner\n";
        ...
        BouncingBallAnimation.main(argsT);


        argsT = new String[]{"1", "1", "5", "2"};
        ...
        argsT = new String[]{String.valueOf(width), String.valueOf(height), "5", "2"};
        title = "ball in the corner\n";
        strT = title + "The input is:\n" + Stream.of(argsT).collect(Collectors.joining(", "));
        ...
        argsT = new String[]{String.valueOf(height - 1), "0", "5", "2"};
        title = "ball in the corner\n";
        strT = title + "The input is:\n" + Stream.of(argsT).collect(Collectors.joining(", "));
        ...
        argsT = new String[]{"-50", "10", "5", "2"};
        title = "ball outside the frame\n";
        strT = title + "The input is:\n" + Stream.of(argsT).collect(Collectors.joining(", "));
        guiT.getDialogManager().showInformationDialog("check5", strT);
        BouncingBallAnimation.main(argsT);

        argsT = new String[]{"50", "10", "5", "2", "3"};
        title = "too much arguments\n";
        strT = title + "The input is:\n" + Stream.of(argsT).collect(Collectors.joining(", "));
        guiT.getDialogManager().showInformationDialog("check6", strT);
        BouncingBallAnimation.main(argsT);

        argsT = new String[]{"50", "10", "5"};
...
//        MultipleBouncingBallsAnimation.main(argsT);
        ...
        strT = title + "The input is:\n" + Stream.of(argsT).collect(Collectors.joining(", "));
        guiT.getDialogManager().showInformationDialog("check10", strT);
        MultipleFramesBouncingBallsAnimation.main(argsT);
        ...
        title = "tons of balls\n";
        strT = title + "The input is:\n" + Stream.of(argsT).collect(Collectors.joining(", "));
        guiT.getDialogManager().showInformationDialog("check11", strT);
        MultipleFramesBouncingBallsAnimation.main(argsT);
        guiT.getDialogManager().showInformationDialog("Finish", "this is the end!");
        guiT.close();
